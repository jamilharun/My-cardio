    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('risk_score', models.DecimalField(decimal_places=2, help_text='AI-generated risk score', max_digits=5)),
                ('diagnosis', models.CharField(help_text='Health risk assessment result', max_length=255)),
                ('recommendations', models.TextField(blank=True, help_text='Suggested preventive actions')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_history', to='main.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='main.customuser')),
            ],
        ),
    ]
